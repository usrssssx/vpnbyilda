...
import { AlertCircle, ArrowRight, Calendar, CreditCard, Globe, Shield, Smartphone } from 'lucide-react';
    ...
    return (
        <div className="flex flex-col lg:flex-row min-h-screen w-full bg-black text-white">
            ...
            >
                ...
                {isLoading ? (
                    <div className="bg-white/10 backdrop-blur-md rounded-xl p-4 sm:p-6">Загружаю подписку...</div>
                ) : error || !subscription ? (
                    ...
                    <>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 mb-6 sm:mb-8">
                            ...
                            <div className="bg-white/10 backdrop-blur-md rounded-xl p-4 sm:p-6">
                                <h2 className="text-lg sm:text-xl font-semibold mb-4">Статус оплаты</h2>
                        ...
                        <div className="bg-white/10 backdrop-blur-md rounded-xl p-4 sm:p-6 mb-6 sm:mb-8">
                            <h2 className="text-lg sm:text-xl font-semibold mb-3 sm:mb-4">Параметры подписки</h2>
