            ...
            <div className="w-full lg:w-[70%] relative p-4 sm:p-6 lg:p-8 flex flex-col"
                ...
                <div className="flex-grow flex flex-col items-center">
                    ...
                    <div className="bg-white/10 backdrop-blur-md rounded-xl p-4 sm:p-6 w-full max-w-xl mb-6 sm:mb-8">
                        ...
                        <button className="w-full py-2.5 sm:py-3 bg-white text-purple-900 rounded-lg font-medium hover:bg-white/90 transition flex items-center justify-center" onClick={() => buyPlan(plans[selectedPlan])} disabled={isSubmitting}>
